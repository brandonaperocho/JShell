...
public class Echo2Test {
  ...
  public void testEchoCurrent() {
    ...
    echo2 = new Echo2(testInput1, main, main);
    // Before overwrite
  ...
  public void testEchoCreateFile() {
    ...
    assertEquals("String1 String2", main.getChildFile("newFile1.txt")
        .getContents());
  }

  @Test
  public void testEchoAppendMultiple() {
    String[] testInput1 = {"String1 String2", ">>", "newFile1.txt"};
    echo2 = new Echo2(testInput1, main, root);
    ...
    // After appending to the same file
    assertEquals("String1 String2\nString1 String2",
        main.getChildFile("newFile1.txt").getContents());
    
    echo2.execute();
    
    // After appending to the same file again
    assertEquals("String1 String2\nString1 String2\nString1 String2",
        main.getChildFile("newFile1.txt").getContents());
  }
}
